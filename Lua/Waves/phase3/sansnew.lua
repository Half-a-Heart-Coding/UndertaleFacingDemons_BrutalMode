...
function SendKnifeSide(ingo,speed)
	if ingo==1 then
		local k=CreateProjectile("KnifeDownDeadly",Player.x,300)
		k.SetVar("time",0)
		k.SetVar("speed",{0,-speed})
		table.insert(knifes,k)
		k.SetVar("color","knife")
		elseif ingo==2 then
		local k=CreateProjectile("KnifeLeftDeadly",300,Player.y)
		k.SetVar("time",0)
		k.SetVar("speed",{-speed,0})
		table.insert(knifes,k)
		k.SetVar("color","knife")
		elseif ingo==3 then
		local k=CreateProjectile("KnifeUpDeadly",Player.x,-300)
		k.SetVar("time",0)
		k.SetVar("speed",{0,speed})
		table.insert(knifes,k)
		k.SetVar("color","knife")
		else
		local k=CreateProjectile("KnifeRightDeadly",-300,Player.y)
		k.SetVar("time",0)
		k.SetVar("speed",{speed,0})
		table.insert(knifes,k)
		k.SetVar("color","knife")
