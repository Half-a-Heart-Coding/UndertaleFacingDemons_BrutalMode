...
Moving()
	...
	if timer == 1 then
		...
		if timer<61 then
			...
			elseif timer<212 then
			local away=300*math.sin((timer-61)*math.pi/300)
			for i=1,6 do
				local angle=(360/#stars)*i+(timer-61)*2+randomangle
				stars[i].MoveTo(away*math.cos(angle*math.pi/180),101+away*math.sin(angle*math.pi/180))
				stars[i].sprite.rotation=stars[i].sprite.rotation+5*stars[i].GetVar("rot")
				local px=Player.x
				local py=Player.y
	...
	if timer == 450 then
		...
		if timer<510 then
			...
			elseif timer<751 then
			local away=300*math.sin((timer-510)*math.pi/300)
			for i=1,6 do
				local angle=(360/#stars)*i+(timer-510)*2+randomangle
				stars[i].MoveTo(away*math.cos(angle*math.pi/180),101+away*math.sin(angle*math.pi/180))
				stars[i].sprite.rotation=stars[i].sprite.rotation+5*stars[i].GetVar("rot")
				local px=Player.x
				local py=Player.y
