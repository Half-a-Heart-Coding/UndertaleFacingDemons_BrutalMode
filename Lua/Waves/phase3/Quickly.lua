...
if spawntime==1 then
	SendKnife({-210,30},{3,0},"KnifeRightDeadly")
	SendKnife({210,30},{-3,0},"KnifeLeftDeadly")
	elseif spawntime==10 then
	SendKnife({-210,10},{3,0},"KnifeRightDeadly")
	SendKnife({210,10},{-3,0},"KnifeLeftDeadly")
	elseif spawntime==20 then
	SendKnife({-210,-10},{3,0},"KnifeRightDeadly")
	SendKnife({210,-10},{-3,0},"KnifeLeftDeadly")
	elseif spawntime==80 then
	SendKnife({0,250},{0,-4},"KnifeDownDeadly")
	SendKnife({-22,-210},{0,4},"KnifeUpDeadly")
	SendKnife({22,-210},{0,4},"KnifeUpDeadly")
	elseif spawntime==140 then
	SendKnife({-24-210,-32},{3,0},"KnifeUpDeadly")
	SendKnife({-24+210,32},{-3,0},"KnifeDownDeadly")
	elseif spawntime==200 then
	SendKnife({24-210,32},{4,0},"KnifeDownDeadly")
	SendKnife({24+210,-32},{-4,0},"KnifeUpDeadly")
	elseif spawntime==260 then
	knife1=SendKnife({32,50},{0,0},"KnifeLeftDeadly",true)
	elseif spawntime==261 then
	knife2=SendKnife({-32,-50},{0,0},"KnifeRightDeadly",true)
end
