...
if spawntime%15==0 then
	local knife=CreateProjectile("KnifeDownDeadly",-90+20*math.random(8),200)
...
if spawntime%200==2 then
	napr=math.random(2)*2-3
	upi=(math.random(2)*2-3)*12.5+12.5
	elseif spawntime%200==60 then
	for i=1,4 do
		local knife=CreateProjectile("KnifeLeftLethal",112*napr,-112.5+50*i-upi)
