...
function DoBroad()
	local knife=CreateProjectile("KnifeDown"..name4,0,45)
	...
	knife=CreateProjectile("KnifeRight"..name4,-45,0)
	knife.sprite.SendToBottom()
	knife.SetVar("time",0)
	knife.SetVar("rot",2)
	knife.SetVar("color","knife")
	knife.sprite.alpha=0
	table.insert(broad,knife)
	knife=CreateProjectile("KnifeUp"..name4,0,-45)
	knife.sprite.SendToBottom()
	knife.SetVar("time",0)
	knife.SetVar("rot",3)
	knife.SetVar("color","knife")
	knife.sprite.alpha=0
	table.insert(broad,knife)
	knife=CreateProjectile("KnifeLeft"..name4,45,0)
	knife.sprite.SendToBottom()
	knife.SetVar("time",0)
	knife.SetVar("rot",0)
	knife.SetVar("color","knife")
...
function BorderShadows(ingo,istrue)
		SendShadow("Down"..name3,{ingo,300},{0,-6},istrue)
		SendShadow("Up"..name3,{ingo,-300},{0,6},istrue)
		SendShadow("Right"..name3,{-300,ingo},{6,0},istrue)
		SendShadow("Left"..name3,{300,ingo},{-6,0},istrue)
end
...
function Update()
	...
	if spawntime==1 then
		...
		spawntime=119
		SendShadow("Right"..name3,{-300,40},{5,0},false)
		SendShadow("Left"..name3,{300,40},{-5,0},false)
		SendShadow("Right"..name3,{-300,-40},{5,0},false)
		SendShadow("Left"..name3,{300,-40},{-5,0},false)
		...
		SendShadow("Down"..name3,{40,300},{0,-5},true)
		SendShadow("Up"..name3,{40,-300},{0,5},true)
		SendShadow("Down"..name3,{-40,300},{0,-5},true)
		SendShadow("Up"..name3,{-40,-300},{0,5},true)
		...
		pos=pos*20
		SendShadow("Right"..name3,{-300,pos},{7,0},true)
		SendShadow("Left"..name3,{300,pos},{-7,0},true)
		SendShadow("Down"..name3,{pos,300},{0,-7},true)
		SendShadow("Up"..name3,{pos,-300},{0,7},true)
		pos=-pos
		SendShadow("Right"..name3,{-300,pos},{7,0},true)
		SendShadow("Left"..name3,{300,pos},{-7,0},true)
		SendShadow("Down"..name3,{pos,300},{0,-7},true)
		...
		SendShadow("Right"..name3,{-45,360},{0,-5},true,4)
		SendShadow("Right"..name3,{-45,-360},{0,5},true,4)
		SendShadow("Left"..name3,{45,360},{0,-5},true,4)
		SendShadow("Left"..name3,{45,-360},{0,5},true,4)
		SendShadow("Down"..name3,{360,45},{-5,0},true,4)
		SendShadow("Down"..name3,{-360,45},{5,0},true,4)
		SendShadow("Up"..name3,{360,-45},{-5,0},true,4)
		SendShadow("Up"..name3,{-360,-45},{5,0},true,4)
	end
