...
HurtUpd()
Moving()
	if attacktimer > 60 and Encounter.GetVar("diff") == 24 then
	...
	if attacktimer==450 then
		DoWarns(20,1)
		DoWarns(50,2)
	elseif attacktimer==480 then
		DoWarns(45,2)
		DoWarns(25,1)
	end

	if attacktimer==510 then
		DoWarns(20,2)
		DoWarns(50,1)
	elseif attacktimer==520 then
		DoWarns(45,1)
		DoWarns(25,2)
	end

	if attacktimer==665 then
		DoWarns(5,1)
		DoWarns(50,1)
	...
	if attacktimer == 700 then
		DoWarns(5,1)
		DoWarns(5,2)
	elseif attacktimer==750 then
		DoWarns(15,1)
		DoWarns(15,2)
	elseif attacktimer==850 then
		DoWarns(50,1)
		DoWarns(50,2)
	elseif attacktimer==900 then
		DoWarns(40,1)
		DoWarns(40,2)
	elseif attacktimer==888 and Encounter.GetVar("diff") == 20 then
		DoWarns(0,1)
		DoWarns(0,2)
	end
