...
function SendShadow(name, position, speed, istrue)
	local knife=CreateProjectile("Knife"..name.."Deadly",position[1],position[2],"Top")
...
if spawntime%48==24 then
	...
	for i=1,2 do
		...
		SendShadow("Down",{x,310},{0,-6},s)
	end
	elseif spawntime%48==0 then
	for i=1,3 do
		local x=-96+48*i
		local s=false
		SendShadow("Down",{x,310},{0,-6},s)
