...
function SendKnife(pos,speed,name,color)
...
if spawntime%10==1 and spawntime<40 then
	...
	i=i/10
	local y=75-25*i
	QuickKnife({200,y},{-5,0},"KnifeLeft"..name3)
	QuickKnife({-200,y},{5,0},"KnifeRight"..name3)
end
if spawntime%36==18 then
	if rand==5 then
		rand=4
		elseif rand==1 then
		rand=2
	...
	for i=1,5 do
		...
		local y=-225
		if i==rand then
			SendKnife({x,y},{0,5.5},"KnifeUp"..name4,"red")
			SendKnife({x,300},{0,-5.5},"KnifeDownBlue"..name3,"blue")
		else
			SendKnife({x,300},{0,-5.5},"KnifeDown"..name3,"gold")
		end
	end
end
