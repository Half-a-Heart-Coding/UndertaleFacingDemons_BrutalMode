...
if Input.Cancel>0 then
	...
	if Input.Up>0 then 
	   Player.MoveTo(Player.x,Player.y+Player_speedy*shift,false)
	end
	if Input.Right>0  then
	   Player.MoveTo(Player.x+Player_speedx*shift,Player.y,false)
	end
