...
function SendKnifeSide(ingo,speed)
	if ingo==1 then
		local k=CreateProjectile("KnifeDown"..name3,Player.x,300)
		k.SetVar("time",0)
		k.SetVar("speed",{0,-speed})
		table.insert(knifes,k)
		k.SetVar("color","knife")
		elseif ingo==2 then
		local k=CreateProjectile("KnifeLeft"..name3,300,Player.y)
		k.SetVar("time",0)
		k.SetVar("speed",{-speed,0})
		table.insert(knifes,k)
		k.SetVar("color","knife")
		elseif ingo==3 then
		local k=CreateProjectile("KnifeUp"..name3,Player.x,-300)
		k.SetVar("time",0)
		k.SetVar("speed",{0,speed})
		table.insert(knifes,k)
		k.SetVar("color","knife")
		else
		local k=CreateProjectile("KnifeRight"..name3,-300,Player.y)
		k.SetVar("time",0)
		k.SetVar("speed",{speed,0})
		table.insert(knifes,k)
		k.SetVar("color","knife")
...
if spawntime==2 then
	...
	if t%90==1 then
		...
		SendKnifeSide(side[num],6)
		SendKnifeSide((side[num]+2)%4,9)
		elseif t%90==40 then
