...
knife = CreateProjectile("KnifeLeft"..name2,210,64)
nohittingtimer=0
...
if attack.GetVar("color")=="white" and collision.CheckCollision(Player,attack) and attack.sprite.alpha then
   ...
   elseif attack.GetVar("color")=="blue" and collision.CheckCollision(Player,attack) and attack.sprite.alpha and isMoving() then
	LongHurt(1,5)
	Effects("burn",1)
    elseif attack.GetVar("color")=="orange" and collision.CheckCollision(Player,attack) and attack.sprite.alpha and not isMoving() then
	LongHurt(1,5)
	Effects("burn",1)
end
end
