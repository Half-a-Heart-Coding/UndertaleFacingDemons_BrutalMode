...
if phase==1 then
	...
	elseif phase==4 then
	if spawntime==1 then
		knife1=CreateProjectile("KnifeDown"..name2,0,352)
		knife2=CreateProjectile("KnifeUp"..name2,0,-352)
		knife3=CreateProjectile("KnifeRight"..name2,-352,0)
		knife4=CreateProjectile("KnifeLeft"..name2,352,0)
