...
if spawntime==82 and phase==2 then
	...
	local knife=CreateProjectile("KnifeLeft"..name3,150,-85+20*i)
	local knife1=CreateProjectile("KnifeRight"..name3,-150,-85+20*i)
	knife.SetVar("speedy",0)
	knife.SetVar("speedx",-7)
	knife.SetVar("color","gold")
	knife1.SetVar("speedy",0)
	knife1.SetVar("speedx",7)
	knife1.SetVar("color","gold")
...
if phase==1 then
	...
	if spawntime%90==80 and spawntime<550 then
		Blue()
	end
...
function OnHit(attacks)
   if attacks.GetVar("color")=="bone" or (attacks.GetVar("color")=="blue" and movi==true) then
	LongHurt(15,60)
	elseif attacks.GetVar("color")=="orange" and movi==false then
	LongHurt(15,60)
      elseif attacks.GetVar("color")=="white" then
	KnifeHurt(1)
	elseif attacks.GetVar("color")=="gold" then
	KnifeHurt(2)
   end
end
...
function Blue()
	if math.random(2) == 1 then
		...
		top1.sprite.color={1, 0.5, 0}
		else1.sprite.color={1, 0.5, 0}
		bot1.sprite.color={1, 0.5, 0}
		top.sprite.Scale(0.5,1)
		top1.sprite.Scale(0.5,1)
		else0.sprite.Scale(0.5,big)
		else1.sprite.Scale(0.5,6)
		...
		top1.SetVar("color","orange")
		else1.SetVar("speedy",0)
		else1.SetVar("speedx",sp)
		else1.SetVar("color","orange")
		bot1.SetVar("speedy",0)
		bot1.SetVar("speedx",sp)
		bot1.SetVar("color","orange")
		table.insert(easybul,top)
		table.insert(easybul,top1)
		table.insert(easybul,else0)
		table.insert(easybul,else1)
