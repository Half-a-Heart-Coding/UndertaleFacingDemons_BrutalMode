...
Moving()
    ...
    if(spawntimer % 50 == 0) then
        local bullet = CreateProjectile('MiniWall', 0, 400)
		local newcolor = math.random(3) 
			if newcolor == 1 then
	...
	if(spawntimer%50 == 45) then
		if math.random(2) == 1 then
			local knife1 = math.random(3)
			if knife1 == 1 then 
				local bullet1 = CreateProjectile ("KnifeRight"..name2, -400, 50)
				local bullet2 = CreateProjectile ("KnifeRight"..name2, -400, 30)
				table.insert(knifes1, bullet1)
				table.insert(knifes1, bullet2)
			elseif knife1 == 2 then 
				local bullet1 = CreateProjectile ("KnifeRight"..name2, -400, 50)
				local bullet2 = CreateProjectile ("KnifeRight"..name2, -400, 10)
				table.insert(knifes1, bullet1)
				table.insert(knifes1, bullet2)
			elseif knife1 == 3 then
				local bullet1 = CreateProjectile ("KnifeRight"..name2, -400, 30)
				local bullet2 = CreateProjectile ("KnifeRight"..name2, -400, 10)
				table.insert(knifes1, bullet1)
				table.insert(knifes1, bullet2)
			end
			...
			if knife2 == 1 then 
				local bullet1 = CreateProjectile ("KnifeLeft"..name2, 400, -10)
			...
			elseif knife2 == 2 then 
				local bullet1 = CreateProjectile ("KnifeLeft"..name2, 400, -50)
				--local bullet2 = CreateProjectile ("KnifeLeft", 400, -50)
				table.insert(knifes2, bullet1)
				table.insert(knifes2, bullet2)
			elseif knife2 == 3 then
				local bullet1 = CreateProjectile ("KnifeLeft"..name2, 400, -30)
				--local bullet2 = CreateProjectile ("KnifeLeft", 400, -50)
				table.insert(knifes2, bullet1)
				table.insert(knifes2, bullet2)
			end
			...
			if knife2 == 1 then 
				local bullet1 = CreateProjectile ("KnifeLeft"..name2, 400, -10)
				local bullet2 = CreateProjectile ("KnifeLeft"..name2, 400, -30)
				table.insert(knifes2, bullet1)
				table.insert(knifes2, bullet2)
			elseif knife2 == 2 then 
				local bullet1 = CreateProjectile ("KnifeLeft"..name2, 400, -10)
				local bullet2 = CreateProjectile ("KnifeLeft"..name2, 400, -50)
				table.insert(knifes2, bullet1)
				table.insert(knifes2, bullet2)
			elseif knife2 == 3 then
				local bullet1 = CreateProjectile ("KnifeLeft"..name2, 400, -30)
