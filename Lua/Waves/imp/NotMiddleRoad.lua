...
if spawntime%45==0 then
	...
	local r=180
	if rand1==1 then
		SendKnife({r*rand2,32},{-2*rand2,0},"KnifeDown"..name3,r)
		SendKnife({-r*rand2,-32},{2*rand2,0},"KnifeUp"..name3,r)
		else
		SendKnife({32,r*rand2},{0,-2*rand2},"KnifeLeft"..name3,r)
		SendKnife({-32,-r*rand2},{0,2*rand2},"KnifeRight"..name3,r)
	end
end
HurtUpd(1200)
Moving()
