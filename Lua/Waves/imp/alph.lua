...
if spawntime%100==0 then
   rand1=math.random(8)+1
   for i=1,10 do           
      if i==rand1 then
         local knife = CreateProjectile("KnifeDownwhite"..name2,-110+i*20,360)        
	...
	knife.SetVar("time",0)
         ...
         else local knife = CreateProjectile("KnifeDown"..name3,-110+i*20,360)
