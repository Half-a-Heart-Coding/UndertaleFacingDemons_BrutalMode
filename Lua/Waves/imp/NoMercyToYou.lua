...
for i=1,10 do
	local k=CreateProjectile("KnifeDown"..name,-110+(220/10)*(i-0.5),150)
	k.sprite.alpha=0
	k.SetVar("time",-60)
...
if spawntime==1 then
	choises={}
	choises[1]=math.random(8)+1--cant pick outside ones, makes nohitable without rng, strat is to go to the middle each time
	--choises[2]=choises[1]
...
if count==10 and spawntime>30 then
	spawntime=0
end
end
